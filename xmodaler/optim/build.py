...
def get_default_optimizer_params(
    ...
    speicial_weight_decay: Optional[Dict[str, float]] = None,
):
    speicial_weight_decay = speicial_weight_decay[0]
    ...
    for module_name, module in model.named_modules():
        for module_param_name, value in module.named_parameters(recurse=False):
            ...
            module_name_speicial_weight_decay = 1.0
            for sss in speicial_weight_decay:
                if sss in module_name:
                    module_name_speicial_weight_decay=speicial_weight_decay[sss]

            params += [
                {
                    "params": [value],
                    "lr": schedule_params["lr"]*module_name_speicial_weight_decay,
...
def build_optimizer(cfg: CfgNode, model: torch.nn.Module) -> torch.optim.Optimizer:
    ...
    params = get_default_optimizer_params(
        ...
        speicial_weight_decay=cfg.SOLVER.SPECIAL_WEIGHT_DECAY,
    )
