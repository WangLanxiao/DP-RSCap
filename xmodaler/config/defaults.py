...
_C.DATALOADER.AUGMENT = 0.5

_C.DATALOADER.IMG_PATH = ''

_C.DATALOADER.ANNO_FOLDER = ''

_C.DATALOADER.ANNO_FOLDER_TRAIN = ''

_C.DATALOADER.ANNO_FOLDER_TRAIN_ID = ''

_C.DATALOADER.ANNO_FOLDER_VAL = ''

_C.DATALOADER.ANNO_FOLDER_VAL_ID  = ''

_C.DATALOADER.ANNO_FOLDER_TEST = ''

_C.DATALOADER.ANNO_FOLDER_TEST_ID  = ''
...
_C.MODEL.FREEZEN = True

_C.MODEL.CLIP_S = True

_C.MODEL.CLIP_E = True

_C.MODEL.BACKBONE = ''

_C.MODEL.BACKBONE_DIM = ''
...
_C.SOLVER.SPECIAL_WEIGHT_DECAY = [{'token_embed.embeddings':1.0}]
...
_C.LR_SCHEDULER.MILESTONES = [100,200]
